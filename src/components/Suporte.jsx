...
export function CriarSuporte() {
    ...
    const handleCriar = async (e) => {
        ...
        try {
            const novoSuporte = await dbService.criarSuporte(nome, sexo, nascimento)
            alert(`Suporte "${novoSuporte.nome}" criado com sucesso!`)
            setNome('')
            setSexo('')
            setNascimento('')
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex justify-center">
            ...
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8 border border-gray-100 h-fit">
                ...
                <div className="mb-8 border-b border-gray-100 pb-5">
                    <h2 className="text-3xl font-extrabold text-gray-800">Criar Novo Suporte</h2>
                ...
                <form onSubmit={handleCriar} className="flex flex-col gap-6">
                    ...
                    {/* Campo: sexo (Agora usando textarea) */}
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Sexo
                        </label>
                        <select
                            ...
                            className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none cursor-pointer"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 cursor-pointer text-gray-700"
                        />
                    </div>
